-- Migration 026: Fix get_feed_data — camelCase JSON keys + 30-day window
--
-- The live function was using snake_case JSON keys (followed_posts,
-- discovery_posts, followed_count) but the JS client expected camelCase
-- (followedPosts, discoveryPosts, followedCreatorCount). The client was
-- reading undefined for all followed posts so they never appeared in the feed.
--
-- Also extends the followed-post window from 48 h to 30 days so older
-- posts from people you follow still appear.
